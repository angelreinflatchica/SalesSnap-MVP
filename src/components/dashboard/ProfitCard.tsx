...
export function ProfitCard({ profit }: ProfitCardProps) {
  ...
  return (
    <Card className="w-full bg-gradient-to-br from-green-50 to-white border-green-100">
      <CardContent className="p-6">
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <p className="text-sm font-medium text-gray-500">{copy.cards.todaysProfit}</p>
              {isPositive && (
